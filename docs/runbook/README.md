...
**Diátaxis**: How-to (operations flavor — on-call audience, post-incident update cadence). **Status**: scaffold; Phase 1 adds first deploy runbook. Most runbooks land Phase 2+ when production-like deploy and monitoring exist.

## Planned content

|           File           |  Phase  |            Trigger            |
|--------------------------|---------|-------------------------------|
| `first-deploy.md`        | Phase 1 | Initial v0.1 deploy procedure |
| `credential-rotation.md` | Phase 1 | Routine secret rotation       |
